...
function updateLocation() {
  navigator.geolocation.watchPosition(function(position) {
      ...
      // Calculate the distance between the user's location and point "p4"
      const distanceToP4 = calculateDistance(userLat, userLng, polylineCoords[11][0], polylineCoords[11][1]);
       // Log the GPS coordinates to the console
       console.log("Current GPS Location: Lat =", userLat, "Lng =", userLng, "distance =", distanceToP4);
      // Set a threshold distance (in meters) to determine "near"
      const thresholdDistance = 170; // Adjust this value as needed

      // If the user is within the threshold distance of point "p4", trigger an alert
      if (distanceToP4 <= thresholdDistance) {
        console.log("tun on the left please");
